...
namespace SchoolbookApp.Data.Migrations
{
    ...
    [Migration("20220109104000_added-room")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolbookApp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SchoolbookApp.Models.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SchoolbookApp.Models.UserSchoolClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserSchoolClass");
                });

            modelBuilder.Entity("SchoolbookApp.Models.UserUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SchoolbookApp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolbookApp.Models.Subject", b =>
                {
                    b.HasOne("SchoolbookApp.Models.Room", "Room")
                        .WithMany()
